package com.xiao.covids.generator;
...
/**
 * @author xiao
 * @Description:自动生成数据库对象代码插件
 * @create 2022-05-29 16:03
 */
public class CodeGenerator {
    ...
    public static void main(String[] args) {
        ...
        dsc.setUrl("jdbc:mysql://127.0.0.1:3306/covid?useUnicode=true&useSSL=false&characterEncoding=utf-8");
